...
const MOCK_ORDER_ITEMS: OrderItem[] = [
  ...
  { order_item_id: 'OI71001-4', order_id: 'SO71001', sku: 'PART-D-004', name: 'Part D Type 4', quantity: 1, picked_quantity: 0, bin_location: 'D-02-01', status: 'PENDING' },
  { order_item_id: 'OI71001-5', order_id: 'SO71001', sku: 'COMP-E-005', name: 'Component E Type 5', quantity: 2, picked_quantity: 0, bin_location: 'E-08-02', status: 'PENDING' },

  // SO71002 - Globex Industries (3 items)
  { order_item_id: 'OI71002-1', order_id: 'SO71002', sku: 'WIDGET-A-001', name: 'Widget A Type 1', quantity: 1, picked_quantity: 0, bin_location: 'A-01-01', status: 'PENDING' },
  { order_item_id: 'OI71002-2', order_id: 'SO71002', sku: 'GADGET-B-002', name: 'Gadget B Type 2', quantity: 2, picked_quantity: 0, bin_location: 'B-05-03', status: 'PENDING' },
  { order_item_id: 'OI71002-3', order_id: 'SO71002', sku: 'TOOL-C-003', name: 'Tool C Type 3', quantity: 1, picked_quantity: 0, bin_location: 'C-10-05', status: 'PENDING' },

  // SO71003 - Soylent Corp (2 items)
  { order_item_id: 'OI71003-1', order_id: 'SO71003', sku: 'PART-D-004', name: 'Part D Type 4', quantity: 3, picked_quantity: 0, bin_location: 'D-02-01', status: 'PENDING' },
  { order_item_id: 'OI71003-2', order_id: 'SO71003', sku: 'COMP-E-005', name: 'Component E Type 5', quantity: 1, picked_quantity: 0, bin_location: 'E-08-02', status: 'PENDING' },

  // SO71004 - Initech (6 items)
  { order_item_id: 'OI71004-1', order_id: 'SO71004', sku: 'WIDGET-A-001', name: 'Widget A Type 1', quantity: 3, picked_quantity: 0, bin_location: 'A-01-01', status: 'PENDING' },
  { order_item_id: 'OI71004-2', order_id: 'SO71004', sku: 'GADGET-B-002', name: 'Gadget B Type 2', quantity: 1, picked_quantity: 0, bin_location: 'B-05-03', status: 'PENDING' },
  { order_item_id: 'OI71004-3', order_id: 'SO71004', sku: 'TOOL-C-003', name: 'Tool C Type 3', quantity: 2, picked_quantity: 0, bin_location: 'C-10-05', status: 'PENDING' },
  { order_item_id: 'OI71004-4', order_id: 'SO71004', sku: 'PART-D-004', name: 'Part D Type 4', quantity: 2, picked_quantity: 0, bin_location: 'D-02-01', status: 'PENDING' },
  { order_item_id: 'OI71004-5', order_id: 'SO71004', sku: 'COMP-E-005', name: 'Component E Type 5', quantity: 1, picked_quantity: 0, bin_location: 'E-08-02', status: 'PENDING' },
  { order_item_id: 'OI71004-6', order_id: 'SO71004', sku: 'MATERIAL-F-006', name: 'Material F Type 6', quantity: 2, picked_quantity: 0, bin_location: 'F-12-03', status: 'PENDING' },

  // SO71005 - Umbrella Corp (4 items)
  { order_item_id: 'OI71005-1', order_id: 'SO71005', sku: 'GADGET-B-002', name: 'Gadget B Type 2', quantity: 4, picked_quantity: 0, bin_location: 'B-05-03', status: 'PENDING' },
  ...
  { order_item_id: 'OI71006-1', order_id: 'SO71006', sku: 'WIDGET-A-001', name: 'Widget A Type 1', quantity: 2, picked_quantity: 2, bin_location: 'A-01-01', status: 'FULLY_PICKED' },
  { order_item_id: 'OI71006-2', order_id: 'SO71006', sku: 'GADGET-B-002', name: 'Gadget B Type 2', quantity: 1, picked_quantity: 1, bin_location: 'B-05-03', status: 'FULLY_PICKED' },
  { order_item_id: 'OI71006-3', order_id: 'SO71006', sku: 'TOOL-C-003', name: 'Tool C Type 3', quantity: 2, picked_quantity: 0, bin_location: 'C-10-05', status: 'PENDING' },
...
async function resetAndSeedDatabase() {
  ...
  try {
    ...
    const MOCK_SKUS = [
      { sku: 'WIDGET-A-001', name: 'Widget A Type 1', category: 'Widgets', description: 'Standard widget type A', active: true },
      { sku: 'GADGET-B-002', name: 'Gadget B Type 2', category: 'Gadgets', description: 'Standard gadget type B', active: true },
      { sku: 'TOOL-C-003', name: 'Tool C Type 3', category: 'Tools', description: 'Standard tool type C', active: true },
      { sku: 'PART-D-004', name: 'Part D Type 4', category: 'Parts', description: 'Standard part type D', active: true },
      { sku: 'COMP-E-005', name: 'Component E Type 5', category: 'Components', description: 'Standard component type E', active: true },
      { sku: 'MATERIAL-F-006', name: 'Material F Type 6', category: 'Materials', description: 'Standard material type F', active: true },
    ];
