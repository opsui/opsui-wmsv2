-- ============================================================================
-- ACCOUNTING & FINANCIAL TABLES (Non-conflicting version)
-- Creates tables for inventory valuation, financial transactions,
-- and accounting without conflicting with existing receipts/shipments tables
-- ============================================================================
...
ALTER TABLE inventory ADD COLUMN IF NOT EXISTS unit_cost DECIMAL(10, 2) DEFAULT 0.00;
...
-- ============================================================================
-- 4. ACCOUNTING RECEIPTS (separate from inbound receiving receipts)
-- ============================================================================
...
-- ============================================================================
-- 5. ACCOUNTING SHIPMENTS (separate from outbound shipping shipments)
-- ============================================================================
...
-- Add sample inventory (update existing inventory records)
UPDATE inventory SET unit_cost = 15.00 WHERE sku = 'SKU10001' AND unit_cost = 0;
UPDATE inventory SET unit_cost = 45.00 WHERE sku = 'SKU10002' AND unit_cost = 0;
UPDATE inventory SET unit_cost = 120.00 WHERE sku = 'SKU10003' AND unit_cost = 0;
UPDATE inventory SET unit_cost = 18.00 WHERE sku = 'SKU10004' AND unit_cost = 0;
UPDATE inventory SET unit_cost = 2.50 WHERE sku = 'SKU10005' AND unit_cost = 0;
...
-- Add sample orders with amounts
UPDATE orders SET total_amount = 1250.00 WHERE order_id = 'ORD-001' AND total_amount = 0;
UPDATE orders SET total_amount = 3200.00 WHERE order_id = 'ORD-002' AND total_amount = 0;
UPDATE orders SET total_amount = 450.00 WHERE order_id = 'ORD-003' AND total_amount = 0;
