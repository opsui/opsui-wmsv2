...
const MOCK_ORDERS: Order[] = [
  ...
  { order_id: 'SO71015', customer_name: 'Hooli 2', status: 'SHIPPED', priority: 'NORMAL', created_at: getDateDaysAgo(25), updated_at: getDateDaysAgo(24), picker_id: 'USR-PICK01', packer_id: 'USR-JMSQXXDN', claimed_at: getDateDaysAgo(24.8), picked_at: getDateDaysAgo(24.5), packed_at: getDateDaysAgo(24.2), shipped_at: getDateDaysAgo(24), progress: 100 },
  { order_id: 'SO71016', customer_name: 'Pied Piper 2', status: 'SHIPPED', priority: 'LOW', created_at: getDateDaysAgo(30), updated_at: getDateDaysAgo(29), picker_id: 'USR-PICK01', packer_id: 'USR-JMSQXXDN', claimed_at: getDateDaysAgo(29.8), picked_at: getDateDaysAgo(29.5), packed_at: getDateDaysAgo(29.2), shipped_at: getDateDaysAgo(29), progress: 100 },

  // More orders spread across the past 40 days for daily/weekly chart visibility
  { order_id: 'SO71017', customer_name: 'SeeFrame', status: 'SHIPPED', priority: 'NORMAL', created_at: getDateDaysAgo(14), updated_at: getDateDaysAgo(13), picker_id: 'USR-PICK01', packer_id: 'USR-JMSQXXDN', claimed_at: getDateDaysAgo(13.8), picked_at: getDateDaysAgo(13.5), packed_at: getDateDaysAgo(13.2), shipped_at: getDateDaysAgo(13), progress: 100 },
  { order_id: 'SO71018', customer_name: 'Aviato 2', status: 'SHIPPED', priority: 'HIGH', created_at: getDateDaysAgo(17), updated_at: getDateDaysAgo(16), picker_id: 'USR-PICK01', packer_id: 'USR-JMSQXXDN', claimed_at: getDateDaysAgo(16.8), picked_at: getDateDaysAgo(16.5), packed_at: getDateDaysAgo(16.2), shipped_at: getDateDaysAgo(16), progress: 100 },
  { order_id: 'SO71019', customer_name: 'Endframe 2', status: 'SHIPPED', priority: 'NORMAL', created_at: getDateDaysAgo(21), updated_at: getDateDaysAgo(20), picker_id: 'USR-PICK01', packer_id: 'USR-JMSQXXDN', claimed_at: getDateDaysAgo(20.8), picked_at: getDateDaysAgo(20.5), packed_at: getDateDaysAgo(20.2), shipped_at: getDateDaysAgo(20), progress: 100 },
  { order_id: 'SO71020', customer_name: 'Bachmanity 2', status: 'SHIPPED', priority: 'LOW', created_at: getDateDaysAgo(28), updated_at: getDateDaysAgo(27), picker_id: 'USR-PICK01', packer_id: 'USR-JMSQXXDN', claimed_at: getDateDaysAgo(27.8), picked_at: getDateDaysAgo(27.5), packed_at: getDateDaysAgo(27.2), shipped_at: getDateDaysAgo(27), progress: 100 },
  { order_id: 'SO71021', customer_name: 'Raviga', status: 'SHIPPED', priority: 'HIGH', created_at: getDateDaysAgo(35), updated_at: getDateDaysAgo(34), picker_id: 'USR-PICK01', packer_id: 'USR-JMSQXXDN', claimed_at: getDateDaysAgo(34.8), picked_at: getDateDaysAgo(34.5), packed_at: getDateDaysAgo(34.2), shipped_at: getDateDaysAgo(34), progress: 100 },
  { order_id: 'SO71022', customer_name: 'Goolybib', status: 'SHIPPED', priority: 'NORMAL', created_at: getDateDaysAgo(38), updated_at: getDateDaysAgo(37), picker_id: 'USR-PICK01', packer_id: 'USR-JMSQXXDN', claimed_at: getDateDaysAgo(37.8), picked_at: getDateDaysAgo(37.5), packed_at: getDateDaysAgo(37.2), shipped_at: getDateDaysAgo(37), progress: 100 },
  { order_id: 'SO71023', customer_name: 'Massive Dynamic 2', status: 'SHIPPED', priority: 'URGENT', created_at: getDateDaysAgo(42), updated_at: getDateDaysAgo(41), picker_id: 'USR-PICK01', packer_id: 'USR-JMSQXXDN', claimed_at: getDateDaysAgo(41.8), picked_at: getDateDaysAgo(41.5), packed_at: getDateDaysAgo(41.2), shipped_at: getDateDaysAgo(41), progress: 100 },
];
...
const MOCK_ORDER_ITEMS: OrderItem[] = [
  ...
  { order_item_id: 'OI71005-1', order_id: 'SO71005', sku: 'WIDGET-A-001', name: 'Widget A Type 1', quantity: 4, picked_quantity: 4, bin_location: 'A-01-01', status: 'FULLY_PICKED' },
  { order_item_id: 'OI71005-2', order_id: 'SO71005', sku: 'GADGET-B-002', name: 'Gadget B Type 2', quantity: 2, picked_quantity: 0, bin_location: 'B-05-03', status: 'PENDING' },
  { order_item_id: 'OI71005-3', order_id: 'SO71005', sku: 'TOOL-C-003', name: 'Tool C Type 3', quantity: 3, picked_quantity: 0, bin_location: 'C-10-05', status: 'PENDING' },
  { order_item_id: 'OI71005-4', order_id: 'SO71005', sku: 'PART-D-004', name: 'Part D Type 4', quantity: 1, picked_quantity: 1, bin_location: 'D-02-01', status: 'FULLY_PICKED' },
  ...
  { order_item_id: 'OI71007-1', order_id: 'SO71007', sku: 'GADGET-B-002', name: 'Gadget B Type 2', quantity: 4, picked_quantity: 4, bin_location: 'B-05-03', status: 'FULLY_PICKED' },
  { order_item_id: 'OI71007-2', order_id: 'SO71007', sku: 'TOOL-C-003', name: 'Tool C Type 3', quantity: 2, picked_quantity: 2, bin_location: 'C-10-05', status: 'FULLY_PICKED' },
  { order_item_id: 'OI71007-3', order_id: 'SO71007', sku: 'PART-D-004', name: 'Part D Type 4', quantity: 3, picked_quantity: 0, bin_location: 'D-02-01', status: 'PENDING' },
  { order_item_id: 'OI71007-4', order_id: 'SO71007', sku: 'COMP-E-005', name: 'Component E Type 5', quantity: 1, picked_quantity: 0, bin_location: 'E-08-02', status: 'PENDING' },
  { order_item_id: 'OI71007-5', order_id: 'SO71007', sku: 'MATERIAL-F-006', name: 'Material F Type 6', quantity: 2, picked_quantity: 0, bin_location: 'F-12-03', status: 'PENDING' },
  ...
  { order_item_id: 'OI71008-2', order_id: 'SO71008', sku: 'GADGET-B-002', name: 'Gadget B Type 2', quantity: 1, picked_quantity: 1, bin_location: 'B-05-03', status: 'FULLY_PICKED' },
  { order_item_id: 'OI71008-3', order_id: 'SO71008', sku: 'TOOL-C-003', name: 'Tool C Type 3', quantity: 2, picked_quantity: 2, bin_location: 'C-10-05', status: 'FULLY_PICKED' },
  ...
  { order_item_id: 'OI71009-1', order_id: 'SO71009', sku: 'COMP-E-005', name: 'Component E Type 5', quantity: 2, picked_quantity: 2, bin_location: 'E-08-02', status: 'FULLY_PICKED' },
  { order_item_id: 'OI71009-2', order_id: 'SO71009', sku: 'MATERIAL-F-006', name: 'Material F Type 6', quantity: 1, picked_quantity: 1, bin_location: 'F-12-03', status: 'FULLY_PICKED' },
  { order_item_id: 'OI71009-3', order_id: 'SO71009', sku: 'WIDGET-A-001', name: 'Widget A Type 1', quantity: 3, picked_quantity: 3, bin_location: 'A-01-01', status: 'FULLY_PICKED' },
  // Remaining orders all have similar item patterns (simplified for brevity)
  // SO71010 (PACKED)
  { order_item_id: 'OI71010-1', order_id: 'SO71010', sku: 'GADGET-B-002', name: 'Gadget B Type 2', quantity: 1, picked_quantity: 1, bin_location: 'B-05-03', status: 'FULLY_PICKED' },
  { order_item_id: 'OI71010-2', order_id: 'SO71010', sku: 'TOOL-C-003', name: 'Tool C Type 3', quantity: 3, picked_quantity: 3, bin_location: 'C-10-05', status: 'FULLY_PICKED' },
  // SO71011 (PACKED)
  { order_item_id: 'OI71011-1', order_id: 'SO71011', sku: 'PART-D-004', name: 'Part D Type 4', quantity: 2, picked_quantity: 2, bin_location: 'D-02-01', status: 'FULLY_PICKED' },
  { order_item_id: 'OI71011-2', order_id: 'SO71011', sku: 'COMP-E-005', name: 'Component E Type 5', quantity: 4, picked_quantity: 4, bin_location: 'E-08-02', status: 'FULLY_PICKED' },
  { order_item_id: 'OI71011-3', order_id: 'SO71011', sku: 'MATERIAL-F-006', name: 'Material F Type 6', quantity: 1, picked_quantity: 1, bin_location: 'F-12-03', status: 'FULLY_PICKED' },
  ...
  { order_item_id: 'OI71012-3', order_id: 'SO71012', sku: 'TOOL-C-003', name: 'Tool C Type 3', quantity: 2, picked_quantity: 2, bin_location: 'C-10-05', status: 'FULLY_PICKED' },
  // SO71013 (SHIPPED - 10 days ago)
  { order_item_id: 'OI71013-1', order_id: 'SO71013', sku: 'PART-D-004', name: 'Part D Type 4', quantity: 3, picked_quantity: 3, bin_location: 'D-02-01', status: 'FULLY_PICKED' },
  ...
  { order_item_id: 'OI71014-1', order_id: 'SO71014', sku: 'TOOL-C-003', name: 'Tool C Type 3', quantity: 4, picked_quantity: 4, bin_location: 'C-10-05', status: 'FULLY_PICKED' },
  { order_item_id: 'OI71014-2', order_id: 'SO71014', sku: 'PART-D-004', name: 'Part D Type 4', quantity: 3, picked_quantity: 3, bin_location: 'D-02-01', status: 'FULLY_PICKED' },
  { order_item_id: 'OI71014-3', order_id: 'SO71014', sku: 'COMP-E-005', name: 'Component E Type 5', quantity: 2, picked_quantity: 2, bin_location: 'E-08-02', status: 'FULLY_PICKED' },
  // SO71015 (SHIPPED - 25 days ago)
  { order_item_id: 'OI71015-1', order_id: 'SO71015', sku: 'MATERIAL-F-006', name: 'Material F Type 6', quantity: 1, picked_quantity: 1, bin_location: 'F-12-03', status: 'FULLY_PICKED' },
  { order_item_id: 'OI71015-2', order_id: 'SO71015', sku: 'WIDGET-A-001', name: 'Widget A Type 1', quantity: 3, picked_quantity: 3, bin_location: 'A-01-01', status: 'FULLY_PICKED' },
  { order_item_id: 'OI71015-3', order_id: 'SO71015', sku: 'GADGET-B-002', name: 'Gadget B Type 2', quantity: 2, picked_quantity: 2, bin_location: 'B-05-03', status: 'FULLY_PICKED' },
  // SO71016 (SHIPPED - 30 days ago)
  { order_item_id: 'OI71016-1', order_id: 'SO71016', sku: 'TOOL-C-003', name: 'Tool C Type 3', quantity: 1, picked_quantity: 1, bin_location: 'C-10-05', status: 'FULLY_PICKED' },
  { order_item_id: 'OI71016-2', order_id: 'SO71016', sku: 'PART-D-004', name: 'Part D Type 4', quantity: 2, picked_quantity: 2, bin_location: 'D-02-01', status: 'FULLY_PICKED' },
  // SO71017 (SHIPPED - 14 days ago)
  { order_item_id: 'OI71017-1', order_id: 'SO71017', sku: 'COMP-E-005', name: 'Component E Type 5', quantity: 3, picked_quantity: 3, bin_location: 'E-08-02', status: 'FULLY_PICKED' },
  { order_item_id: 'OI71017-2', order_id: 'SO71017', sku: 'MATERIAL-F-006', name: 'Material F Type 6', quantity: 2, picked_quantity: 2, bin_location: 'F-12-03', status: 'FULLY_PICKED' },
  { order_item_id: 'OI71017-3', order_id: 'SO71017', sku: 'WIDGET-A-001', name: 'Widget A Type 1', quantity: 1, picked_quantity: 1, bin_location: 'A-01-01', status: 'FULLY_PICKED' },
  // SO71018 (SHIPPED - 17 days ago)
  { order_item_id: 'OI71018-1', order_id: 'SO71018', sku: 'GADGET-B-002', name: 'Gadget B Type 2', quantity: 2, picked_quantity: 2, bin_location: 'B-05-03', status: 'FULLY_PICKED' },
  { order_item_id: 'OI71018-2', order_id: 'SO71018', sku: 'TOOL-C-003', name: 'Tool C Type 3', quantity: 1, picked_quantity: 1, bin_location: 'C-10-05', status: 'FULLY_PICKED' },
  // SO71019 (SHIPPED - 21 days ago)
  { order_item_id: 'OI71019-1', order_id: 'SO71019', sku: 'PART-D-004', name: 'Part D Type 4', quantity: 4, picked_quantity: 4, bin_location: 'D-02-01', status: 'FULLY_PICKED' },
  { order_item_id: 'OI71019-2', order_id: 'SO71019', sku: 'COMP-E-005', name: 'Component E Type 5', quantity: 2, picked_quantity: 2, bin_location: 'E-08-02', status: 'FULLY_PICKED' },
  // SO71020 (SHIPPED - 28 days ago)
  { order_item_id: 'OI71020-1', order_id: 'SO71020', sku: 'MATERIAL-F-006', name: 'Material F Type 6', quantity: 1, picked_quantity: 1, bin_location: 'F-12-03', status: 'FULLY_PICKED' },
  { order_item_id: 'OI71020-2', order_id: 'SO71020', sku: 'WIDGET-A-001', name: 'Widget A Type 1', quantity: 2, picked_quantity: 2, bin_location: 'A-01-01', status: 'FULLY_PICKED' },
  { order_item_id: 'OI71020-3', order_id: 'SO71020', sku: 'GADGET-B-002', name: 'Gadget B Type 2', quantity: 3, picked_quantity: 3, bin_location: 'B-05-03', status: 'FULLY_PICKED' },
  // SO71021 (SHIPPED - 35 days ago)
  { order_item_id: 'OI71021-1', order_id: 'SO71021', sku: 'TOOL-C-003', name: 'Tool C Type 3', quantity: 2, picked_quantity: 2, bin_location: 'C-10-05', status: 'FULLY_PICKED' },
  { order_item_id: 'OI71021-2', order_id: 'SO71021', sku: 'PART-D-004', name: 'Part D Type 4', quantity: 1, picked_quantity: 1, bin_location: 'D-02-01', status: 'FULLY_PICKED' },
  // SO71022 (SHIPPED - 38 days ago)
  { order_item_id: 'OI71022-1', order_id: 'SO71022', sku: 'COMP-E-005', name: 'Component E Type 5', quantity: 3, picked_quantity: 3, bin_location: 'E-08-02', status: 'FULLY_PICKED' },
  { order_item_id: 'OI71022-2', order_id: 'SO71022', sku: 'MATERIAL-F-006', name: 'Material F Type 6', quantity: 2, picked_quantity: 2, bin_location: 'F-12-03', status: 'FULLY_PICKED' },
  { order_item_id: 'OI71022-3', order_id: 'SO71022', sku: 'WIDGET-A-001', name: 'Widget A Type 1', quantity: 1, picked_quantity: 1, bin_location: 'A-01-01', status: 'FULLY_PICKED' },
  // SO71023 (SHIPPED - 42 days ago)
  { order_item_id: 'OI71023-1', order_id: 'SO71023', sku: 'GADGET-B-002', name: 'Gadget B Type 2', quantity: 2, picked_quantity: 2, bin_location: 'B-05-03', status: 'FULLY_PICKED' },
  { order_item_id: 'OI71023-2', order_id: 'SO71023', sku: 'TOOL-C-003', name: 'Tool C Type 3', quantity: 1, picked_quantity: 1, bin_location: 'C-10-05', status: 'FULLY_PICKED' },
];
...
async function resetAndSeedDatabase() {
  ...
  try {
    ...
    for (const sku of MOCK_SKUS) {
      await client.query('INSERT INTO skus (sku, name, description, category, barcode, active, created_at, updated_at) VALUES ($1, $2, $3, $4, $5, $6, NOW(), NOW())', [sku.sku, sku.name, sku.description, sku.category, sku.barcode, sku.active]);
    }
    ...
    for (const item of MOCK_ORDER_ITEMS) {
      await client.query('INSERT INTO order_items (order_item_id, order_id, sku, name, quantity, picked_quantity, bin_location, status) VALUES ($1, $2, $3, $4, $5, $6, $7, $8)', [item.order_item_id, item.order_id, item.sku, item.name, item.quantity, item.picked_quantity, item.bin_location, item.status]);
    }
