...
export type UserRoleValue = 'PICKER' | 'PACKER' | 'STOCK_CONTROLLER' | 'INWARDS' | 'DISPATCH' | 'SUPERVISOR' | 'ADMIN' | 'PRODUCTION' | 'SALES' | 'MAINTENANCE' | 'RMA' | 'ACCOUNTING' | 'HR_MANAGER' | 'HR_ADMIN';
/**
...
export declare const PERMISSION_GROUPS: {
    readonly ORDERS: readonly [Permission.VIEW_ORDERS, Permission.CREATE_ORDERS, Permission.EDIT_ORDERS, Permission.DELETE_ORDERS, Permission.ASSIGN_ORDERS];
    readonly PICKING: readonly [Permission.VIEW_PICK_TASKS, Permission.CLAIM_PICK_TASK, Permission.COMPLETE_PICK_TASK, Permission.SKIP_PICK_TASK];
    readonly PACKING: readonly [Permission.VIEW_PACK_TASKS, Permission.CLAIM_PACK_TASK, Permission.COMPLETE_PACK_TASK];
    readonly INVENTORY: readonly [Permission.VIEW_INVENTORY, Permission.ADJUST_INVENTORY, Permission.VIEW_STOCK_MOVEMENTS];
    readonly STOCK_CONTROL: readonly [Permission.PERFORM_CYCLE_COUNTS, Permission.APPROVE_CYCLE_COUNTS, Permission.MANAGE_LOCATIONS, Permission.VIEW_LOCATION_CAPACITY];
    readonly INWARDS: readonly [Permission.PROCESS_RECEIPTS, Permission.MANAGE_PUTAWAYS];
    readonly REPORTS: readonly [Permission.VIEW_REPORTS, Permission.GENERATE_REPORTS, Permission.EXPORT_DATA];
    readonly USERS: readonly [Permission.VIEW_USERS, Permission.CREATE_USERS, Permission.EDIT_USERS, Permission.DELETE_USERS, Permission.MANAGE_USER_ROLES, Permission.MANAGE_CUSTOM_ROLES];
    readonly EXCEPTIONS: readonly [Permission.VIEW_EXCEPTIONS, Permission.RESOLVE_EXCEPTIONS, Permission.APPROVE_EXCEPTION_RESOLUTIONS];
    readonly SETTINGS: readonly [Permission.VIEW_SETTINGS, Permission.MANAGE_INTEGRATIONS, Permission.MANAGE_BUSINESS_RULES];
    readonly QUALITY_CONTROL: readonly [Permission.PERFORM_QC_CHECKS, Permission.APPROVE_QC_RESULTS];
    readonly PRODUCTION: readonly [Permission.VIEW_PRODUCTION_TASKS, Permission.MANAGE_PRODUCTION];
    readonly SALES: readonly [Permission.VIEW_SALES_ORDERS, Permission.MANAGE_SALES];
    readonly MAINTENANCE: readonly [Permission.VIEW_MAINTENANCE_TASKS, Permission.MANAGE_MAINTENANCE];
    readonly RMA: readonly [Permission.VIEW_RMA_REQUESTS, Permission.PROCESS_RMA];
    readonly DISPATCH: readonly [Permission.VIEW_SHIPMENTS, Permission.CREATE_SHIPMENTS, Permission.CANCEL_SHIPMENTS];
    readonly ACCOUNTING: readonly [Permission.VIEW_FINANCIALS, Permission.MANAGE_FINANCIALS, Permission.EXPORT_FINANCIALS, Permission.MANAGE_TRANSACTIONS];
    readonly HR: readonly [Permission.VIEW_EMPLOYEES, Permission.MANAGE_EMPLOYEES, Permission.VIEW_TIMESHEETS, Permission.APPROVE_TIMESHEETS, Permission.VIEW_PAYROLL, Permission.PROCESS_PAYROLL, Permission.VIEW_LEAVE_REQUESTS, Permission.MANAGE_LEAVE_REQUESTS, Permission.MANAGE_LEAVE_BALANCES, Permission.VIEW_HR_REPORTS, Permission.MANAGE_HR_SETTINGS];
};
/**
...
export interface OrderItem {
    ...
    binLocation: string;
    status: OrderItemStatus | TaskStatus;
    barcode?: string;
    skipReason?: string;
    unitPrice?: number;
    lineTotal?: number;
...
export declare class WMSError extends Error {
    code: string;
    statusCode: number;
    details?: unknown | undefined;
    constructor(code: string, statusCode: number, message: string, details?: unknown | undefined);
}
export declare class InventoryError extends WMSError {
    constructor(message: string, details?: unknown);
}
export declare class ValidationError extends WMSError {
    constructor(message: string, details?: unknown);
}
export declare class NotFoundError extends WMSError {
    constructor(resource: string, id?: string);
}
export declare class ConflictError extends WMSError {
    constructor(message: string, details?: unknown);
}
export declare class UnauthorizedError extends WMSError {
    constructor(message?: string);
}
export declare class ForbiddenError extends WMSError {
    constructor(message?: string);
}
/**
 ...
 */
export declare enum PutawayStatus {
    PENDING = "PENDING",
    IN_PROGRESS = "IN_PROGRESS",
    COMPLETED = "COMPLETED",
    CANCELLED = "CANCELLED"
 ...
 */
export declare enum ASNLineStatus {
    PENDING = "PENDING",
    PARTIALLY_RECEIVED = "PARTIALLY_RECEIVED",
 ...
 */
export declare enum LicensePlateStatus {
    OPEN = "OPEN",
    SEALED = "SEALED",
    IN_QC = "IN_QC",
    QC_PASSED = "QC_PASSED",
 ...
 */
export declare enum StagingLocationStatus {
    AVAILABLE = "AVAILABLE",
    OCCUPIED = "OCCUPIED",
    RESERVED = "RESERVED",
    BLOCKED = "BLOCKED"
 ...
 */
export declare enum ReceivingExceptionType {
 ...
 */
export declare enum ReceivingExceptionStatus {
    OPEN = "OPEN",
 ...
 */
export declare enum ReceivingExceptionResolution {
 ...
 */
export declare enum CycleCountType {
 ...
 */
export declare enum AutomationTaskType {
 ...
 */
export declare enum AutomationTaskStatus {
    PENDING = "PENDING",
    ASSIGNED = "ASSIGNED",
    IN_PROGRESS = "IN_PROGRESS",
    COMPLETED = "COMPLETED",
 ...
 */
export declare enum CapacityRuleStatus {
    ACTIVE = "ACTIVE",
    INACTIVE = "INACTIVE",
    WARNING = "WARNING",
    EXCEEDED = "EXCEEDED"
 ...
 * Accounting Period
 */
export declare enum AccountingPeriod {
    DAILY = "DAILY",
    WEEKLY = "WEEKLY",
    MONTHLY = "MONTHLY",
    QUARTERLY = "QUARTERLY",
 ...
 * Revenue Category
 */
export declare enum RevenueCategory {
    SALES = "SALES",
 ...
 */
export declare enum RevenueRecognitionMethod {
    INSTANT = "INSTANT",
    MILESTONE = "MILESTONE",
    RATABLE = "RATABLE",
    DEFERRED = "DEFERRED"
