 ...
 */
export declare enum SalesOrderLineStatus {
    PENDING = "PENDING",
    PICKED = "PICKED",
    SHIPPED = "SHIPPED",
    INVOICED = "INVOICED",
 ...
 */
export declare enum OrderSourceChannel {
    WEB = "WEB",
    PHONE = "PHONE",
    EMAIL = "EMAIL",
    FAX = "FAX",
 ...
 */
export declare enum CommissionTransactionType {
    SALE = "SALE",
    PAYMENT = "PAYMENT",
...
//# sourceMappingURL=sales-crm.d.ts.map