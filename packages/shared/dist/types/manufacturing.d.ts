 ...
 * MRP Plan Status
 */
export declare enum MRPPlanStatus {
    DRAFT = "DRAFT",
 ...
 * MRP Action Type
 */
export declare enum MRPActionType {
 ...
 */
export declare enum ShopFloorTransactionType {
    CLOCK_ON = "CLOCK_ON",
    CLOCK_OFF = "CLOCK_OFF",
 ...
 */
export declare enum CapacityPlanStatus {
    DRAFT = "DRAFT",
    SUBMITTED = "SUBMITTED",
    APPROVED = "APPROVED",
    ACTIVE = "ACTIVE",
