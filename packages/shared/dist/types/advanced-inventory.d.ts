 ...
 */
export declare enum LandedCostComponentType {
    FREIGHT = "FREIGHT",
    DUTY = "DUTY",
    INSURANCE = "INSURANCE",
    HANDLING = "HANDLING",
 ...
 */
export declare enum LayerTransactionType {
    RECEIPT = "RECEIPT",
    TRANSFER = "TRANSFER",
 ...
 */
export declare enum DepletionTransactionType {
    SHIPMENT = "SHIPMENT",
 ...
 */
export declare enum CycleCountStrategy {
    ABC_BASED = "ABC_BASED",
    RANDOM = "RANDOM",
    VELOCITY = "VELOCITY",
    LOCATION = "LOCATION",
 ...
 * Count priority
 */
export declare enum CountPriority {
    HIGH = "HIGH",
    MEDIUM = "MEDIUM",
    LOW = "LOW"
}
 ...
 */
export declare enum SafetyStockMethod {
 ...
 */
export declare enum VelocityCategory {
    FAST = "FAST",
    SLOW = "SLOW",
    OBSOLETE = "OBSOLETE",
    DEAD = "DEAD"
...
//# sourceMappingURL=advanced-inventory.d.ts.map