 ...
 */
export declare enum IntercompanyTransactionType {
 ...
 */
export declare enum IntercompanyTransactionStatus {
    PENDING = "PENDING",
    POSTED = "POSTED",
 ...
 * Entity user roles
 */
export declare enum EntityUserRole {
 ...
 */
export declare enum ConsolidationMethod {
 ...
 */
export declare enum EntityAuditAction {
