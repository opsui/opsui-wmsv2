 ...
 */
export const CANCELLABLE_ORDER_STATES = new Set([
    OrderStatus.PENDING,
    OrderStatus.PICKING,
]);
/**
 ...
 */
export const PICKER_REQUIRED_STATES = new Set([
    OrderStatus.PICKING,
    OrderStatus.PICKED,
]);
/**
 ...
 */
export const PACKER_REQUIRED_STATES = new Set([
    OrderStatus.PACKING,
    OrderStatus.PACKED,
]);
/**
 ...
 */
export function getNextStates(fromStatus) {
    // eslint-disable-next-line @typescript-eslint/no-unnecessary-condition, security/detect-object-injection
 ...
 */
export function isPickerRequired(status) {
 ...
 */
export function isPackerRequired(status) {
 ...
 * );
 */
export async function validateTransition(fromStatus, toStatus, context) {
