...
export function validateSKU(sku) {
    ...
    if (!SKU_PATTERN.test(trimmed)) {
        throw new ValidationError('Invalid SKU format. Must be 2-80 characters using letters, numbers, spaces, and common SKU punctuation');
    }
}
// ============================================================================
...
export function validateBinLocation(binLocation) {
    ...
    if (!BIN_LOCATION_PATTERN.test(trimmed)) {
        throw new ValidationError('Invalid bin location format. Expected format: ZONE-AISLE-SHELF (e.g., A-12-03)');
    }
}
// ============================================================================
// ORDER VALIDATION
// ============================================================================
function validateSingleOrderItem(item, seenSKUs) {
...
// PICK VALIDATION
// ============================================================================
export function validatePickQuantity(quantity, orderQuantity, alreadyPicked) {
    ...
    if (quantity > remaining) {
        throw new ValidationError(`Cannot pick more than remaining quantity. Remaining: ${remaining}, attempted: ${quantity}`);
    }
}
export function validatePickSKU(scannedSKU, expectedSKU) {
    ...
    if (normalizedScanned !== normalizedExpected) {
        throw new ValidationError(`Wrong SKU scanned. Expected: ${expectedSKU}, scanned: ${scannedSKU}`);
    }
}
// ============================================================================
// USER VALIDATION
