 ...
 * Format: PT-XXXXXXXX
 */
export function generatePickTaskId() {
 ...
 * Format: IU-XXXXXXXX
 */
export function generateInventoryUnitId() {
 ...
 */
export function generateStateChangeId(date = new Date()) {
    const dateStr = date.toISOString().slice(0, 10).replace(/-/g, '');
 ...
 */
export function generateBinId(zone, aisle, shelf) {
 ...
 */
export function parseBinLocation(binId) {
 ...
 */
export function sortBinsForPicking(bins) {
