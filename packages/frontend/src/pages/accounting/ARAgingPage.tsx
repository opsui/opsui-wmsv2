      ...
      <main className="relative z-10 w-full px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6">
            ...
            <div className="space-y-4">
              ...
              <p className="text-gray-600 dark:text-gray-400 max-w-xl text-lg leading-relaxed">
                Track outstanding invoices by aging period to optimize collections and cash flow
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className="w-full sm:w-auto px-4 py-3 rounded-xl text-sm bg-white dark:bg-slate-800/50 border border-gray-300 dark:border-slate-700 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-amber-500/30 focus:border-amber-500/30"
                />
              </div>
              ...
              <div className="flex items-center gap-2">
                <Button
                  variant="secondary"
                  onClick={exportToCSV}
                  className="action-button-enhanced flex items-center gap-2 px-4 py-2.5 rounded-xl bg-amber-100 dark:bg-amber-500/20 border border-amber-300 dark:border-amber-500/30 text-amber-700 dark:text-amber-300 hover:bg-amber-200 dark:hover:bg-amber-500/30"
                >
        ...
        {isLoading ? (
          ...
          <div className="space-y-6">
            ...
            >
              <div className="bg-gradient-to-r from-amber-100 dark:from-amber-500/10 to-amber-50 dark:to-amber-600/5 px-6 py-5 border-b border-amber-200 dark:border-amber-500/10">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <div className="p-2.5 bg-amber-200 dark:bg-amber-500/20 rounded-xl">
              ...
              <div className="p-6">
                <div className="space-y-3">
                  ...
                  {/* Total Row */}
                  <div className="flex items-center justify-between py-4 px-4 mt-4 bg-amber-50 dark:bg-amber-500/10 rounded-xl border border-amber-200 dark:border-amber-500/20">
                    <span className="text-sm font-bold text-gray-800 dark:text-gray-200 uppercase tracking-wider">
                      Total Outstanding
                    </span>
                    <div className="flex items-center gap-4">
                      <span className="text-xs text-gray-500 dark:text-gray-400">
                        {mockReport.buckets.reduce((sum, b) => sum + b.count, 0)} invoices
                      </span>
                      <span className="ledger-currency text-xl font-bold text-amber-600 dark:text-amber-400">
              ...
              <div className="p-6">
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-right">
                    <p className="text-xs text-gray-500 dark:text-gray-400 mb-1">Current Ratio</p>
                ...
                <div className="mt-6">
                  ...
                  <div className="flex justify-between mt-2">
                    <span className="text-xs text-rose-500 dark:text-rose-400">Poor</span>
                    <span className="text-xs text-amber-500 dark:text-amber-400">Fair</span>
                    <span className="text-xs text-emerald-500 dark:text-emerald-400">Good</span>
                  </div>
                </div>
