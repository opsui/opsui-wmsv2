...
function ExceptionBadge({ status }: { status: ExceptionStatus }) {
  const statusConfig: Record<ExceptionStatus, { color: string; label: string }> = {
    [ExceptionStatus.OPEN]: {
      color:
        'bg-red-100 dark:bg-red-900/60 text-red-700 dark:text-red-300 border border-red-200 dark:border-red-500/50',
      label: 'OPEN',
    },
    [ExceptionStatus.REVIEWING]: {
      color:
        'bg-yellow-100 dark:bg-yellow-900/60 text-yellow-700 dark:text-yellow-300 border border-yellow-200 dark:border-yellow-500/50',
      label: 'REVIEWING',
    },
    [ExceptionStatus.APPROVED]: {
      color:
        'bg-blue-100 dark:bg-blue-900/60 text-blue-700 dark:text-blue-300 border border-blue-200 dark:border-blue-500/50',
      label: 'APPROVED',
    },
    [ExceptionStatus.REJECTED]: {
      color:
        'bg-gray-100 dark:bg-gray-700/60 text-gray-700 dark:text-gray-300 border border-gray-200 dark:border-gray-500/50',
      label: 'REJECTED',
    },
    [ExceptionStatus.RESOLVED]: {
      color:
        'bg-green-100 dark:bg-green-900/60 text-green-700 dark:text-green-300 border border-green-200 dark:border-green-500/50',
      label: 'RESOLVED',
    },
      ...
      {showResolveModal && selectedException && (
        <div className="fixed inset-0 z-50 overflow-y-auto">
          <div className="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
            ...
            {/* Modal panel */}
            <div className="inline-block align-bottom bg-white dark:bg-gray-900 rounded-2xl text-left overflow-hidden shadow-premium-lg transform transition-all sm:my-8 sm:align-middle sm:max-w-2xl sm:w-full animate-scale-in border dark:border-gray-700 border-gray-200">
              {/* Modal header */}
              <div className="bg-gray-50 dark:bg-gray-800 px-6 py-4 sm:px-6 flex items-center justify-between border-b border-gray-200 dark:border-gray-700">
                <div>
              ...
              <div className="px-6 py-5 sm:px-6 max-h-[60vh] overflow-y-auto">
                ...
                <div className="mb-6">
                  ...
                  <div className="p-4 bg-gray-50 dark:bg-white/[0.02] rounded-xl border border-gray-200 dark:border-white/[0.08]">
                    ...
                    <div className="grid grid-cols-2 gap-3 text-sm">
                      ...
                      <div className="bg-white dark:bg-gray-800/50 p-2 rounded-lg">
                        <span className="text-xs text-gray-500 dark:text-gray-400 block">SKU</span>
                        <span className="text-gray-900 dark:text-white font-medium">
                ...
                <div className="space-y-4">
                  ...
                  {/* Conditional Fields */}
                  <div className="bg-gray-50 dark:bg-white/[0.02] rounded-xl p-4 border border-gray-200 dark:border-white/[0.08]">
                    ...
                    {resolution === ExceptionResolution.SUBSTITUTE && (
                      <div className="mb-3">
                        ...
                        <input
                          ...
                          className="w-full px-3 py-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:border-primary-500"
              ...
              {/* Modal footer */}
              <div className="bg-gray-50 dark:bg-white/[0.02] px-6 py-4 sm:px-6 sm:flex sm:flex-row-reverse gap-3 border-t border-gray-200 dark:border-gray-700">
                <Button
                  variant="primary"
