...
const moduleName = 'Packing';
const description = 'Streamlined packing operations with quality checks';
const features = ['Pack verification', 'Weight validation', 'Label printing', 'Quality control'];
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: '#0F172A' }}>
      ...
      <Sequence from={sceneDuration} durationInFrames={sceneDuration}>
        <PackingModule accentColor={accentColor} />
      </Sequence>
