...
const description = 'Comprehensive reporting and analytics';
const features = ['Custom reports', 'Data export', 'Trend analysis', 'Performance dashboards'];
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: '#0F172A' }}>
      ...
      <Sequence from={sceneDuration} durationInFrames={sceneDuration}>
        <ReportsModule accentColor={accentColor} />
      </Sequence>
