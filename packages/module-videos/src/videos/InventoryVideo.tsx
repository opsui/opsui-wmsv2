...
const description = 'Complete inventory control and optimization';
const features = ['Stock tracking', 'Cycle counting', 'Bin management', 'Slotting optimization'];
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: '#0F172A' }}>
      ...
      <Sequence from={sceneDuration} durationInFrames={sceneDuration}>
        <InventoryModule accentColor={accentColor} />
      </Sequence>
