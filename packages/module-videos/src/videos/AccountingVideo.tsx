...
const description = 'Financial management and reporting';
const features = ['Invoice tracking', 'Budget management', 'Cost analysis', 'Financial reports'];
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: '#0F172A' }}>
      ...
      <Sequence from={sceneDuration} durationInFrames={sceneDuration}>
        <AccountingModule accentColor={accentColor} />
      </Sequence>
